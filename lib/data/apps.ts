...
export const apps: App[] = [
  ...
  },
  {
    ...
    stages: ["delivery"],
    capabilities: ["field-execution"],
    industries: ["construction"],
    pricing: "usage-volume-based",
    founded: 2021,
    featured: false,
    addedAt: "2026-03-30",
  },
  ...
  },
  {
    ...
    stages: ["delivery"],
    capabilities: ["documents-cde", "field-execution", "quality-inspections"],
    industries: ["construction"],
    pricing: "per-project-program",
    founded: 2002,
    featured: true,
  ...
  },
  {
    ...
    pricing: "services-implementation-contract",
    founded: 2016,
    featured: true,
    addedAt: "2026-02-01",
    editorNote:
  ...
  },
  {
    ...
    capabilities: ["scheduling-planning"],
  ...
  },
  {
    ...
    stages: ["definition", "delivery"],
    capabilities: ["bim-model-coordination", "scheduling-planning"],
    industries: ["construction", "infrastructure"],
    pricing: "per-seat",
    founded: 2001,
    featured: false,
