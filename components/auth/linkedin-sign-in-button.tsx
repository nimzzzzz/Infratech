...
export function LinkedInSignInButton({
  ...
  return (
    <button
      ...
      onClick={handleClick}
      disabled={!isLoaded}
      className="group mt-10 inline-flex h-12 w-full items-center justify-center gap-2.5 bg-[#0A66C2] px-5 text-[14px] font-medium text-white transition-colors hover:bg-[#0959AB] active:translate-y-[1px] disabled:cursor-wait disabled:opacity-90 sm:h-14 sm:text-[15px]"
    >
